...
public class Robot extends IterativeRobot
{
    ...
    {
        boolean testingCameraCode = false;
        if (testingCameraCode)
        {
        ...
        else
        {
            ...
            double c = 3500.0 / newR.height;
            double inchesPerPixel = 5.0 / newR.height;
            double b = turn * inchesPerPixel;
            double a = Math.sqrt(c * c - b * b);
            System.out.println("turn: " + turn + ", centerX: " + centerX);
            System.out.println("rect: " + newR.toString());
            System.out.println("Size: " + contours);
            System.out.println("True Distance: " + c + "X distance: " + b + "Y distance" + a);
            if (joy1.getTrigger())
            {
